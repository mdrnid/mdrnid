...
### 🛠️ Professional Focus & Activities
- 🎓 **Education:** Currently pursuing a degree in Computer Engineering at UNM.
- 🔭 **Current Focus:** Deepening my expertise in **AI Engineering**, specifically in Machine Learning workflows and Deep Learning architectures.
- 🌱 **Learning Path:** Actively exploring **Large Language Models (LLMs)** and **Big Data Technologies** to bridge the gap between raw data and intelligent insights.
- ⚡ **Goal:** Building end-to-end AI solutions that are scalable and efficient.

---

### 💻 Tech Stack & Tools

**Core Languages & Data Handling**
